...
def given_a_build_chain(chain_id, builds):
    ...
    httpretty.register_uri(GET, stats_gatherer().build_chain_path % chain_id, body='{"build": [%s]}' % builds_list)
...
def test_all_successful_build_chain_stats_for_one_successful_build_chain(http_mock, stats_gatherer):
    ...
    assert stats_gatherer.all_successful_build_chain_stats('configuration_id') == [BuildChain(1,
...
def test_all_successful_build_chain_stats_for_two_successful_build_chains():
    ...
    assert stats_gatherer.all_successful_build_chain_stats('configuration_id') == [
        BuildChain(1,
                   [BuildStat(11, 'build_configuration11', 11, datetime_fixture),
                    BuildStat(12, 'build_configuration12', 12, datetime_fixture)]),
        BuildChain(2,
